...
const JobsPage: NextPage = () => {
  ...
  return (
    <div className={styles.examplesContainer}>
      ...
      <p>
        Next, you can try something. First, make sure you&apos;re logged in.
        Then open a second tab and open the same url. Log yourself out in the
        second tab. Then come back to the first tab and see what happens once
        you focus the tab. =)
      </p>
      <p>
    ...
    <div>
      ...
      {liveWeather.result.status === 'ok' && (
        <div>
          ...
          <h3>Wind</h3>
          <p>
            {JSON.stringify(liveWeather.result.data.getCityByName.weather.wind)}
          </p>
        </div>
      )}
    </div>
