...
const Mocks: NextPage = () => {
  ...
  return (
    <div>
      ...
      <p>
        For each Operation you define, the code generator automatically
        generates all the models and scaffolds a config object to create
        typesafe mocks.
      </p>
      <p>
      ...
      <p>
        You can define complex logic if you want, or use an in memory data
        structure or even a database if you want stateful mocks.
      </p>
      <p>
      ...
      <p>
        The use of the method from the clients&apos; perspective can be found
        at&nbsp;
