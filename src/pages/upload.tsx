...
const UploadPage: NextPage = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <h3>
        To enable file uploads cd into <code>minio</code>, run{' '}
        <code>docker-compose up</code> and then <code>sh setup.sh</code> to
        start your own S3 server using docker compose & minio.
      </h3>
      <div>
